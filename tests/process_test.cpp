...
{
    Process p1{2599, test_map, kFixturePath};
...
{
    Process p1{1234, test_map, kFixturePath};
...
TEST_F(ProcessTest, StatParseUpTime)
{
    ...
    EXPECT_EQ(static_cast<long>(453078.54 - static_cast<double>(3390) / sysconf(_SC_CLK_TCK)), p1.UpTime());
}
...
{
    Process p1{2599, test_map, kFixturePath};
    Process p2{1234, test_map, kFixturePath};
